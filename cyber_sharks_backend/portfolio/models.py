...
class ContactPreferences(models.Model):
    portfolio = models.OneToOneField('Portfolio', on_delete=models.CASCADE, related_name='contact_preferences')
    preferred_method = models.CharField(max_length=20, choices=CONTACT_METHOD_CHOICES, default='EMAIL')
...
class Portfolio(models.Model):
    ...
    profile_name = models.CharField(max_length=255)  # Renamed from 'biography' to 'profile_name' to match API
    ...
    location = models.ForeignKey(Location, on_delete=models.CASCADE, related_name='portfolios')
